...
class DownloadProgressUpdater( private val downloadManager: DownloadManager,
        ...
        while (downloadId > 0){
            ...
            downloadManager.query(query).use { cursor->
                if(cursor.moveToFirst()){
                    if(totalBytes <= 0){
                        totalBytes = cursor.getInt(cursor.getColumnIndex
                    ...
                    when(cursor.getInt(cursor.getColumnIndex(DownloadManager.COLUMN_STATUS))){
                        ...
                        DownloadManager.STATUS_FAILED ->{
                            ...
                            val bytesDownloadedSoFar = cursor.getInt(cursor.getColumnIndex(DownloadManager
